# PowerShell script to create all checkout components

$componentsPath = "src\components\checkout"
      ...
      <div className="bg-gradient-to-r from-[#00BCD4]/10 to-white p-5">
        ...
        <div className="flex gap-4">
          <div className="relative w-24 h-24 flex-shrink-0 bg-slate-100 rounded-xl overflow-hidden">
            <Image
              src={productInfo.productImage || '/placeholder.png'}
...
Set-Content -Path "$componentsPath\ProductSummaryCard.tsx" -Value $productSummary

Write-Host "Created ProductSummaryCard.tsx" -ForegroundColor Green

# Continue with other components...
Write-Host "All checkout components created successfully!" -ForegroundColor Green
